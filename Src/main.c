...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, ST67_NSS_Pin|ST67_LP_WAKEUP_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ST67_NSS_Pin ST67_LP_WAKEUP_Pin */
  GPIO_InitStruct.Pin = ST67_NSS_Pin|ST67_LP_WAKEUP_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : ST67_DATA_RDY_Pin */
  GPIO_InitStruct.Pin = ST67_DATA_RDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ST67_DATA_RDY_GPIO_Port, &GPIO_InitStruct);
