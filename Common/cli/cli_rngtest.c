...
static void prvRngst67_echoCommand( ConsoleIO_t * const pxCIO,
                               uint32_t ulArgc,
                               char * ppcArgv[] );

const CLI_Command_Definition_t xCommandDef_rngst67_echo =
{
    "rngst67_echo",
    "rngst67_echo <number of bytes>\r\n"
    "    Read the specified number of bytes from the rng and output them base64 encoded.\r\n\n",
    prvRngst67_echoCommand
};
